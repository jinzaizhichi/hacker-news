...
export function Volume() {
  return (
    <VolumeSlider.Root className="volume-slider group relative mx-2 inline-flex h-10 w-32 cursor-pointer touch-none select-none items-center outline-none aria-hidden:hidden">
      ...
      <VolumeSlider.Preview className="-translate-y-4 pointer-events-none flex flex-col items-center opacity-0 transition-opacity duration-200 data-[visible]:opacity-100" noClamp>
